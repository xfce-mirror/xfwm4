...
static void
getSizeExcludingMargins(Client *c, GdkRectangle *rect, int *full_x, int *full_y, int *full_w, int *full_h, bool only_same_monitor)
{
...
static void
updateSizeExcludingMargins(Client *c, GdkRectangle *rect, bool only_same_monitor)
{
