...
gboolean
getSizeExcludingMargins (ScreenInfo *screen_info,
                         GdkRectangle *area,
                         GdkRectangle *dest)
{
    ...
    return gdk_rectangle_intersect (&screen_rect, area, dest);
}

void
getMaxSpace(ScreenInfo *screen_info, GdkRectangle *area)
{
...
clientInitPosition (Client * c)
{
    ...
    getSizeExcludingMargins(screen_info, &rect, &full);
