...
create_dialog (McsPlugin * mcs_plugin)
{
    ...
    gtk_box_pack_start (GTK_BOX (hbox), dialog->scrolledwindow1, TRUE, TRUE,
			0);
    ...
    gtk_container_add (GTK_CONTAINER (dialog->frame_align),
		       create_radio_button_table (title_align_values, 3,
						  _
						  ("Text alignment inside title bar :"),
						  title_align,
						  G_CALLBACK
    ...
    gtk_box_pack_start (GTK_BOX (hbox), dialog->scrolledwindow2, TRUE, TRUE,
			0);
    gtk_scrolled_window_set_shadow_type (GTK_SCROLLED_WINDOW
    ...
    gtk_box_pack_start (GTK_BOX (vbox6), dialog->raise_on_focus_check, FALSE,
			FALSE, 0);
    gtk_toggle_button_set_active (GTK_TOGGLE_BUTTON
				  (dialog->raise_on_focus_check),
				  focus_raise);
    ...
    gtk_box_pack_start (GTK_BOX (vbox7), dialog->snap_to_border_check, FALSE,
			FALSE, 0);
    gtk_toggle_button_set_active (GTK_TOGGLE_BUTTON
				  (dialog->snap_to_border_check),
				  snap_to_border);
    ...
    gtk_box_pack_start (GTK_BOX (vbox7), dialog->snap_to_windows_check, FALSE,
			FALSE, 0);
    gtk_toggle_button_set_active (GTK_TOGGLE_BUTTON
				  (dialog->snap_to_windows_check),
				  snap_to_windows);
    ...
    gtk_box_pack_start (GTK_BOX (vbox8), dialog->wrap_workspaces_check, FALSE,
			FALSE, 0);
    gtk_toggle_button_set_active (GTK_TOGGLE_BUTTON
				  (dialog->wrap_workspaces_check),
				  wrap_workspaces);
    ...
    gtk_box_pack_start (GTK_BOX (vbox9), dialog->box_resize_check, FALSE,
			FALSE, 0);
    gtk_toggle_button_set_active (GTK_TOGGLE_BUTTON
    ...
    gtk_box_pack_start (GTK_BOX (vbox9), dialog->box_move_check, FALSE, FALSE,
			0);
    ...
    gtk_container_add (GTK_CONTAINER (frame),
		       create_radio_button_table (dbl_click_values, 4,
						  _
						  ("Action to perform when double clicking on title bar :"),
						  dbl_click_action,
						  G_CALLBACK
